#ifndef INCLUDE_KMMQTT_MQTT_PARAMS_PUBCOMPOPTIONS_H
#define INCLUDE_KMMQTT_MQTT_PARAMS_PUBCOMPOPTIONS_H
...
namespace kmMqtt
{
	...
	{
		/**
		 * @brief Options for PUBCOMP packet creation.
		 */
...
#endif //INCLUDE_KMMQTT_MQTT_PARAMS_PUBCOMPOPTIONS_H 
